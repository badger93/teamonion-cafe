...
const AdminOrderHistoryPresenter = ({ orderHistoryData, getHistoryDataByState }) => {
  ...
  const colums = [
    {
      key: 'order_id', name: '주문아이디', width: 70, resizable: true,
    },
    {
      key: 'member_id', name: '주문자ID', width: 100, resizable: true,
    },
    {
      key: 'menus', name: '주문', resizable: true,
    },
    {
      key: 'paymentType', name: '결제타입', width: 60, resizable: true,
    },
    {
      key: 'createdDate', name: '주문시간', width: 100, resizable: true,
    },
    {
      key: 'amount', name: '총액', width: 100, resizable: true,
    },
    {
      key: 'paid', name: '결제여부', width: 60, resizable: true,
    },
    {
      key: 'made', name: '제조여부', width: 60, resizable: true,
    },
    {
      key: 'pickup', name: '픽업여부', width: 60, resizable: true,
    },
  ];
